...
if("TRUE" STREQUAL "TRUE")
  set(robotiq_modbus_rtu_SOURCE_PREFIX /home/stefan/u10e_ws/src/robotiq/robotiq_modbus_rtu)
  set(robotiq_modbus_rtu_DEVEL_PREFIX /home/stefan/u10e_ws/devel/.private/robotiq_modbus_rtu)
  ...
  set(robotiq_modbus_rtu_INSTALL_PREFIX /home/stefan/u10e_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/stefan/u10e_ws/src/robotiq/robotiq_modbus_rtu/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/stefan/u10e_ws/devel/.private/robotiq_modbus_rtu/lib;/home/stefan/u10e_ws/devel/lib;/home/stefan/ws_moveit/devel/lib;/opt/ros/noetic/lib)
